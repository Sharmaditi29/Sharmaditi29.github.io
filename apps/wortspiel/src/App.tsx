...
function App() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      <div className="mx-auto w-full max-w-[1500px] px-4 py-4 sm:px-5 sm:py-5 lg:px-7 xl:px-8 xl:py-6">
        <Header />

        <main className="mt-4 grid gap-4 xl:grid-cols-[minmax(330px,360px)_minmax(0,1fr)] xl:items-start xl:gap-5">
          <aside className="rounded-[28px] bg-paper/66 p-5 sm:p-6 xl:flex xl:flex-col">
            <LanguageBar
          ...
          <section className="flex flex-col gap-4">
            {selectedLanguage === 'german' && isGermanDeckLoading && (
              <div className="rounded-[18px] bg-paper/72 px-4 py-3 text-sm font-bold text-notebook">
